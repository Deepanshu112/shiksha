...
function getBotResponse(input) {
    ...
    if (input.includes("hi") || input.includes("hello") || input.includes("hey")) {
        ...
        else if (input.includes("educational domain") || input.includes("our domain")) {
            return "We have 3 options: Engineering, Medical, and Commerce. Please choose one.";
        }
        // } else if (input.includes("engineering")) {
        //     const engineeringCourses = courses.filter(course => course.category === "GATE");
        //     return formatCourses(engineeringCourses);
        // } else if (input.includes("medical")) {
        //     // Assuming there are medical courses available in the 'courses' array
        //     const medicalCourses = courses.filter(course => course.category === "Medical");
        //     return formatCourses(medicalCourses);
        // } else if (input.includes("commerce")) {
        //     // Assuming there are commerce courses available in the 'courses' array
        //     const commerceCourses = courses.filter(course => course.category === "Commerce");
        //     return formatCourses(commerceCourses);
        // }
            ...
            // Ask user to choose a subdomain
            return "Which field (subdomain) of engineering would you like to explore? Options are: Civil, Computer Science, AIML, Cloud, Data Science, or Other. If you're not sure, type 'no idea'.";
        } else if (input.toLowerCase().includes("no idea")) {
            // Respond with current market trends in engineering
            return "Here are current market trends in engineering. Some of them are Cloud, Web3, Cryptography, etc.";
        } 
